...
***Following instructions lack some required details, reflecting that this was a learning experience on AWS. See TODO list at bottom***  
...
3. On the AWS EC2 Service page, create an EC2 instance. It must be created in one of the regions which allows incoming smtp email, such as *us-west-2 (Oregon)*. A T2 Micro instance should suffice.3. 
